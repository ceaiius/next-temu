...
const Cart = () => {
  ...
  return (
    <>
        {isOpen && (
            <div className='fixed inset-0  bg-opacity-50 z-50 transition-opacity backdrop-blur-sm' onClick={close}>
            </div>
                    ...
                    <div className='flex-1 overflow-y-auto'>
                        {items.length === 0 ? (
                            <div className='flex flex-col items-center justify-center h-full p-4 text-center'>
                                ...
                                <h3 className='text-lg font-semibold text-rgay-900 mb-2'>
                                    Your cart is empty
                                </h3>
                                <p className='text-gray-500 mb-6'>
                                    Looks like you have not added any items to your cart yet!
                                </p>
                                <Link href="/" onClick={close} className='bg-black text-white px-6 py-2 rounded-full font-medium hover:bg-gray-900 transition-colors'>
                                    Start Shopping
                                </Link>
                            </div>
                        ) : (
