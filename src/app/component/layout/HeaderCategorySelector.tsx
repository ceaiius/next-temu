...
const HeaderCategorySelector = async () => {
  ...
  return (
    <div className='relative inline-block'>
        <button className='peer group text-gray-700 hover:text-gray-900 font-medium text-sm flex items-center gap-1'>
            Categories
            <svg 
                ...
                <div className='py-2'>
                    {categories.map((category) => (
                        <Link
                             ...
                             className='block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 transition duration-100 ease-in-out'
                             prefetch
                             >{category.title}
                             </Link>
                    ))}
