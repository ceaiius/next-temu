        ...
        <Form action={formAction} className="max-w-md mx-auto p-8 my-16 bg-white rounded-lg shadow-md">
            ...
            <div className='space-y-6'>
                ...
                <button 
                    type='submit'
                    disabled={isPending}
                    className={`w-full bg-rose-600 text-white py-3 rounded-md hover:bg-rose-700 transition-colors font-medium flex items-center justify-center ${isPending ? 'cursor-not-allowed' : ''}`}>
                        {isPending ? (
                            <React.Fragment>
