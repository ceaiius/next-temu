import SalesCampaignBanner from '@/app/component/layout/SalesCampaignBanner';
import AddToCartButton from '@/app/component/product/AddToCartButton';
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-2 mt-4'>
                        <div className='flex items-center gap-3'>
                            ...
                            <div className='flex flex-col'>
                                <span className='text-lg text-gray-400 line-through decoration-red-500/50 decoration-2'>{formatPrice(originalPrice)}</span>
                            <div className='flex items-center gap-2'>
                    ...
                    <div className='flex flex-col gap-3 mt-6 text-sm bg-white p-4 rounded-xl shadow-sm border border-gray-100'>
                        <div className='flex items-center gap-3 text-gray-700'>
                            ...
                            <span className='font-medium'>In stock - Ships withing 24 hours</span>
                        </div>
                        <div className='flex items-center gap-3 text-gray-700'>
                            <span className='bg-green-100 p-2 rounded-full'>💸</span>
